...
def calculate_demographic_data(print_data=True):
    ...
    rich_min_workers = len(min_hours_workers[min_hours_workers['salary'] == '>50K'])
    rich_percentage = round(rich_min_workers / num_min_workers * 100, 1)
    print('rich', rich_percentage)

    # What country has the highest percentage of people that earn >50K?
    rich = df[df['salary'] == '>50K']
    country_total = df['native-country'].value_counts()
    country_rich = rich['native-country'].value_counts()
    ...
    india=rich[rich['native-country'] == 'India']
